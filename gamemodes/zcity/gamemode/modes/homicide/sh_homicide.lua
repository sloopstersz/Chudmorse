...
local HeroWeaponData = {
	...
	["weapon_revolver357"] = {extraClips = 0},
	["weapon_dracovska"] = {extraClips = 0, sling = true},
...
local HeroUpgradeData = {
	...
	["hero_revolver357_ammo"] = {parent = "weapon_revolver357", type = "ammo", extraClips = 1},
	...
	["hero_dracovska_ammo"] = {parent = "weapon_dracovska", type = "ammo", extraClips = 1},
	["hero_dracovska_silencer"] = {parent = "weapon_dracovska", type = "attachment", attachment = "supressor8"},
