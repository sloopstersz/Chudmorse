...
exclusions = {
    ...
    hero = {
        ...
        items = {
			...
			["weapon_draco"] = {cost = 8, name = "Draco", desc = "A Smaller Rifle, good for ease of use."},
        ...
        addons = {
			...
			["hero_draco_silencer"] = {cost = 2, name = "Draco Suppressor", parent = "weapon_draco", attachment = "supressor8", desc = "Supress the Draco."},
			["hero_draco_ammo"] = { cost = 2, name = "Draco Extra Ammo", parent = "weapon_draco", desc = "Start with extra magazine."},
       ...
       addonOrder = {
			...
			["weapon_draco"] = {"hero_draco_silencer", "hero_draco_ammo"},
