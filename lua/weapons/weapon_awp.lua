...
SWEP.Instructions = "Bolt-action Sniper Rifle chambered in .308 NATO"
...
SWEP.FakeBodyGroups = "0001411140"
...
SWEP.FakeReloadSounds = {
	...
	[0.65] = "weapons/arccw_ur/aw/magin.ogg",
...
SWEP.AnimList = {
	["idle"] = "idle",
	["reload"] = "reload_exte",
	["reload_empty"] = "reload_exte",
	["cycle"] = "cycle",
}

SWEP.ScrappersSlot = "Primary"
SWEP.WepSelectIcon2 = Material("entities/awp.png")
SWEP.IconOverride = "entities/awp.png"
SWEP.weight = 6.5
...
SWEP.Primary.Sound = {"weapons/arccw_ur/aw/fire-01.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/arccw_ur/aw/fire-sup-01.ogg", 65, 90, 100}
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor8", Vector(-0.5,0,0), {}},
		["mount"] = Vector(1.5,26,0),
...
SWEP.PPSMuzzleEffect = "muzzleflash_SR25" -- shared in sh_effects.lu
...
SWEP.AimHands = Vector(-10, 1.8, -7.1)
