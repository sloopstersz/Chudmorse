...
--SWEP.MagIndex = 6
SWEP.WepSelectIcon2 = Material("entities/hk33ea2p.png")
SWEP.IconOverride = "entities/hk33ea2p.png"
SWEP.weight = 3.81
...
SWEP.ReloadTime = 4.8
SWEP.FakeBodyGroups = "10414020041"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(16.5,1,9.4)
...
SWEP.availableAttachments = {
	...
	grip = {
		["mount"] = Vector(10, 0, 0.0),
		["mountType"] = "picatinny"
	},
	underbarrel = {
	[1] = {"laser5", Vector(0.0,0.2,0.33), {}},

	["mount"] = {["picatinny_small"] = Vector(13, -0.4, -0.1),["picatinny"] = Vector(17,-1.2,0.8)},
