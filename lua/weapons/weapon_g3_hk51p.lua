...
SWEP.PrintName = "MC51 Pica"
SWEP.Author = "Imperial Defence Services Ltd"
...
SWEP.WepSelectIcon2 = Material("entities/mc51p.png")
SWEP.IconOverride = "entities/mc51p.png"
SWEP.weight = 3.1
...
SWEP.ReloadTime = 5.1
SWEP.FakeBodyGroups = "00210280021"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(9.004,1,9.4)
