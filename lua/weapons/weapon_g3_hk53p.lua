...
--SWEP.MagIndex = 6
SWEP.WepSelectIcon2 = Material("entities/hk53ea3p.png")
SWEP.IconOverride = "entities/hk53ea3p.png"
SWEP.weight = 3
...
SWEP.Primary.Sound = {"weapons/arccw_ur/g3/fire-556-01.ogg", 85, 80, 90}
SWEP.SupressedSound = {"weapons/arccw_ur/g3/fire-sup-01.ogg", 65, 90, 100}
SWEP.Primary.Wait = 0.085
SWEP.ReloadTime = 4.8
SWEP.FakeBodyGroups = "10214280021"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(9.5,1,9.4)
SWEP.LocalMuzzleAng = Angle(-0.0,-0.25,0)
SWEP.WeaponEyeAngles = Angle(0,0,0)

SWEP.holsteredBone = "ValveBiped.Bip01_Spine2"
SWEP.holsteredPos = Vector(-2.5, 9, -15)
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.02 - math.cos(i) * 0.02, math.cos(i * i) * 0.02, 0) * 2
end
SWEP.RecoilMul = 1.1
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(2.5,0.5,-0.25), {}},
		["mount"] = Vector(-1.85,0.2,0.15),
	},
	sight = {
		["mount"] = {picatinny = Vector(-15.42, 1.5, 0.03)},
		["mountType"] = {"picatinny"},
		["empty"] = {
			"empty",
		},
	...
	grip = {
		["mount"] = Vector(11, 0.3, 0.0),
		["mountType"] = "picatinny"
	},
	underbarrel = {
	[1] = {"laser5", Vector(0.0,0.2,0.33), {}},
	
		["mount"] = {["picatinny_small"] = Vector(8, -0.4, -0.1),["picatinny"] = Vector(11,-1.2,0.8)},
		["mountAngle"] = {["picatinny_small"] = Angle(-0.95, 0.1, 0),["picatinny"] = Angle(0.4, 0.1, 90)},
...
SWEP.AnimList = {
	["idle"] = "idle",
	["reload"] = "reload_30rnd",
	["reload_empty"] = "reload_empty_30rnd",
}
