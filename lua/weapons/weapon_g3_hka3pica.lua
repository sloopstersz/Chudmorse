...
SWEP.WepSelectIcon2 = Material("entities/hkg3a3p.png")
SWEP.IconOverride = "entities/hkg3a3p.png"
SWEP.weight = 4.41
...
SWEP.ReloadTime = 5.1
SWEP.FakeBodyGroups = "00000020001"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.availableAttachments = {
	...
	["mount"] = {["picatinny_small"] = Vector(0, -0.4, -0.1),["picatinny"] = Vector(5,-1.2,0.8)},
