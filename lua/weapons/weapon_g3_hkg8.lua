...
--SWEP.MagIndex = 6
SWEP.WepSelectIcon2 = Material("entities/hkg8.png")
SWEP.IconOverride = "entities/hkg8.png"
SWEP.weight = 7.5
...
SWEP.ReloadTime = 8
SWEP.FakeBodyGroups = "00002013001"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.95] = "weapons/arccw_ur/g3/chamber.ogg",
...
SWEP.AnimList = {
	["idle"] = "idle",
	["reload"] = "reload_50rnd",
	["reload_empty"] = "reload_empty_scope_50rnd",
}
